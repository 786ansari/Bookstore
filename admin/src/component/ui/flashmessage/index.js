...
const FlashMessge = () => {
  ...
  const handleCurrencyDelete = async(row) => {
    ...
    let result  = await removeFlash(data)
    ResultFunction(result,getFlashMessage,setCategoryName)
  ...
  return (
    <>
                  ...
                  <div class="card-header">
                    ...
                    <div class="dropdown">
                      ...
                      >
                        ...
                        <CSVLink class="dropdown-item" data={messageList}>
                          Export as CSV
                        </CSVLink>
                      </div>
                      <button
      ...
      <UpdateFlashMessage data={flashDataForUpdate} get={getFlashMessage}/>
      <AddFlashMessage get={getFlashMessage} />
